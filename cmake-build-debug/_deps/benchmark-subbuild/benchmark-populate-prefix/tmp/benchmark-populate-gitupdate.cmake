...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v1.8.4"
  WORKING_DIRECTORY "/Users/gannonstoner/efficient-event-processing/cmake-build-debug/_deps/benchmark-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/gannonstoner/efficient-event-processing/cmake-build-debug/_deps/benchmark-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/gannonstoner/efficient-event-processing/cmake-build-debug/_deps/benchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
